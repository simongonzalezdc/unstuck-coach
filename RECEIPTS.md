...
| The live demo proves the first move before setup | `landing/index.html`, `SUBMISSION.md`, `scripts/verify-console-behavior.mjs` | The landing routes to the hosted GLM demo for real chat while the verifier keeps protocol classification proof out of the visible journey. |
...
| It is presentation-ready | `PITCH_REEL.md`, `landing/reel.html`, `scripts/verify-pitch-reel.mjs`, `scripts/verify-reel-page.mjs`, `WALKTHROUGH.md`, `landing/index.html`, `RECEIPTS.md` | A short recording can show thesis, handoff, live demo, receipts, and verifier without exposing local review notes. |
