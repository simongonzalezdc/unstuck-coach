...
const landingRequiredText = [
  ...
  "Calendar blocks, inbox triage, and prior context are not an add-on;",
  "they are the state-aware surfaces where a lot of life becomes real again.",
  "Uses supplied context before asking for state",
  "Calendar/inbox",
