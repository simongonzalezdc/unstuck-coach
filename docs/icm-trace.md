...
| Make decisions inspectable | Show what counts as good or failed coaching before the judge reads the whole folder. | `FIRST_REPLY_SCORECARD.md`, `FIRST_RUN.md`, `docs/judge-scorecard.md` |
| Preserve context without overload | Hold the rest of the task list outside working memory while returning one concrete move. | `rules.md`, `reference/signal-map.md`, `docs/handoff-card.md` |
...
| Separate research material from execution | Keep protocols, signals, safety, and research lineage in reference files instead of burying them in prompts. | `reference/` |
...
| Make proof inspectable | Pair claims with readable receipts, scorecards, transcripts, and stress cases. | `docs/receipts.md`, `FIRST_REPLY_SCORECARD.md`, `demo/transcript-pack.md` |
| Keep publication auditable | Keep the public repository, landing page, live demo, and submission draft aligned. | `SUBMISSION.md`, `landing/index.html`, `README.md` |
...
- `reference/`: reusable protocols, signal maps, safety boundaries, and research notes.
...
- `docs/judge-scorecard.md`: the broader competition scoring frame.
- `docs/receipts.md`: claim-to-file proof.
...
- Vague claims about methodology without scorecards, receipts, or transcripts.
...
5. Inspect this trace and the receipt map in `docs/receipts.md`.
